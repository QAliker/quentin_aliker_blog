...
const SignUpPage = () => {
    ...
    if (isSuccess) {
        ...
        return (
            ...
            <Field name="email" type="email" className="border-2 p-2" placeholder="Enter a Email" />
            <ErrorMessage name="email" component="p" className="text-red-500" />
            <label htmlFor="password">Password</label>
            <Field name="password" type="text" className="border-2 p-2" placeholder="Enter your password" />
            <ErrorMessage name="password" component="p" className="text-red-500" />
            <button type="submit" className="px-3 py-2 bg-blue-600 active:bg-blue-700 text-2xl text-white">
            Sign Up
            </button>
            </Form>
            </Formik>
